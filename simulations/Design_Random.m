clear;clc; close all
high=80;low=20;scale=30;mid=50;Num=100;
A=[];B=[];cor=5;
kk=1;
...
for beta=1
    for alpha=ones(1,1).*0.5
        ...
        a0=80;b0=80;
        for i=1:Num
            a=a+randn*randi([scale/2,scale]);b=b+randn*randi([scale/2,scale]);
            a0=a+randn*randi(5);b0=b+randn*randi(5);
...
set(gcf,'unit','normalized','position',[0,0,0.4,0.5])
saveas(gca,'RandomWalk3.jpg')
%%
